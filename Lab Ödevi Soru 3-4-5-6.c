...
#include<stdlib.h>
#include<string.h>
//Student isimli Struct Oluşturma ve Gerekli Bilgileri Yazma
struct student{
	char name[40];
	int age;
	int number;
...
//Listede Gezinme ve Ogrenci Bilgilerini Yazdırma
...
//Main Fonksiyonu İçinde Fonksiyonları Yazdırma
int main()
{
	node* head=NULL;
	int secim;
